        ...
        <div class="row-container">
            ...
            <div class="icon-indicator-row">
                ...
                <div
                    ...
                    :class="{
                        errorInputIconIndicator: errorMessage,
                    }"
                >
                    <div>
...
.errorInputIconIndicator {
    border: solid 2px #f34336;
    border-left: none;
}
input:focus + .errorInputIconIndicator {
    border-top: solid 2px #6f499b;
    border-right: solid 2px #6f499b;
    border-bottom: solid 2px #6f499b;
    border-left: none;
}
input:focus {
