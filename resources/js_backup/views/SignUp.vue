    ...
    setup() {
        ...
        watch(
            ...
            _.debounce(() => {
                ...
                data_errors["company_id"] = "";
                if (v_required(company_code.value)) {
        ...
        watch(
            ...
            _.debounce(() => {
                ...
                data_errors["work_email_address"] = "";
                if (v_required(work_email.value)) {
                    work_email_status.value = 3;
                    return;
                }
                if (v_email(work_email.value)) {
                    data_errors["work_email_address"] = [
        ...
        watch(
            ...
            _.debounce(() => {
                ...
                if (v_username(form.username)) {
                    data_errors["username"] = [
                        "The Username field should not contain whitespace.",
                    ];
        ...
        const validate = () => {
            ...
            if (v_required(form.first_name)) {
                data_errors["first_name"] = [
                    "The First Name field is required.",
                ];
                hasError.value = true;
            }
            if (v_required(form.last_name)) {
                data_errors["last_name"] = ["The Last Name field is required."];
                hasError.value = true;
            }
            if (v_required(form.work_email_address)) {
                data_errors["work_email_address"] = [
                    "The Work Email Address field is required.",
                ];
                hasError.value = true;
            }
            if (v_email(form.work_email_address)) {
                data_errors["work_email_address"] = [
                    "The Work Email field must be a valid email address.",
                ];
                hasError.value = true;
            }
            if (v_required(form.username)) {
            ...
            if (v_required(form.company_id) && v_required(company_code.value)) {
                data_errors["company_id"] = [
                    "The Company Code field is required.",
                ];
                hasError.value = true;
            }
            if (company_code.value && v_required(form.company_id)) {
                data_errors["company_id"] = [
                    "The Company Code you entered does not exist.",
                ];
                hasError.value = true;
