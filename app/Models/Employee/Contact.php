...
class Contact extends Model
{
     ...
     */
    protected $primaryKey = EmployeeConstants::EMPLOYEE_CONTACTS_PRIMARY_KEY;
    
    /**
     * Table name
     */
    protected $table = EmployeeConstants::EMPLOYEE_CONTACTS_TABLE_NAME;
    ...
    /**
     * Function to set the contact information belong to an employee
     */
