...
class WorkExperience extends Model
{
     ...
     */
    protected $primaryKey = EmployeeConstants::EMPLOYEE_WORK_EXPERIENCE_PRIMARY_KEY;
    
    /**
     * Table name
     */
    protected $table = EmployeeConstants::EMPLOYEE_WORK_EXPERIENCE_TABLE_NAME;
    ...
    /**
     * Function to set the work experience information belong to an employee
     */
